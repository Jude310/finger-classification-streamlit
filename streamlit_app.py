...
def app():
    ...
    st.title('Number of Fingers Classification')
    st.subheader('edited by Angel Jude Diones, BSCS 3A Student')
    ...
    text = """Feature representation: Binary values (1 or 0) representing the 8x8 pixels of an image.
        ...
        of the image (in this case, of fingers risen).
        Description of data set:"""
    st.write(text)
    st.write('The dataset shows 4x10 images of the number of fingers risen.')
    st.write('The objective of this particular machine learning model')
    st.write('is to show how different models such as Naive Bayes or Logistic Regression')
    st.write('is able to correctly classify the number of fingers risen.')
